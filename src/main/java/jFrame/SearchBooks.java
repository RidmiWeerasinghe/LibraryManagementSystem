...
public class SearchBooks extends javax.swing.JFrame {
     ...
     */
    String BookID, ISBN, bookName, Author, Publisher, No_of_pages, Edition, Category, Status;

    public SearchBooks(String CurrentNIC) {
        initComponents();
        //System.out.println("current user nic " + CurrentNIC);
        lbl_NIC.setText(CurrentNIC);
    ...
    public void setBookDetailsToTable() {
        try {
            ...
            while (rs1.next()) {
                ...
                Object[] obj = {ISBN, bookName, Author, Publisher, No_of_pages, Edition, Category, Status};
                model.addRow(obj);
            }
    ...
    private void initComponents() {
        ...
        btn_reserve = new rojerusan.RSMaterialButtonRectangle();
        ...
        jPanel2.add(btn_Add5, new org.netbeans.lib.awtextra.AbsoluteConstraints(1070, 10, 110, 50));
        ...
        jPanel1.add(cBox_Search, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 90, 340, 30));
        ...
        jPanel1.add(txt_Search, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 130, 340, 30));
        ...
        jPanel1.add(btn_Search, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 170, 110, 50));
        ...
        jPanel1.add(btn_clear, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 170, 110, 50));

        btn_reserve.setBackground(new java.awt.Color(0, 153, 255));
        btn_reserve.setText("Reserve");
        btn_reserve.setFont(new java.awt.Font("Segoe UI Semibold", 1, 14)); // NOI18N
        btn_reserve.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_reserveActionPerformed(evt);
            }
        });
        jPanel1.add(btn_reserve, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 530, 110, 50));

        lbl_NIC.setFont(new java.awt.Font("Segoe UI Semibold", 1, 16)); // NOI18N
        lbl_NIC.setForeground(new java.awt.Color(102, 102, 102));
        lbl_NIC.setText("null");
        jPanel1.add(lbl_NIC, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 100, 230, 30));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 280, 1110, 230));

        lbl_NIC1.setFont(new java.awt.Font("Segoe UI Semibold", 1, 16)); // NOI18N
        lbl_NIC1.setForeground(new java.awt.Color(102, 102, 102));
        lbl_NIC1.setText("NIC :");
        jPanel1.add(lbl_NIC1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 100, 40, 30));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                String CurrentNIC = null;
                new SearchBooks(CurrentNIC).setVisible(true);
            }
        });
    }
    ...
    private rojerusan.RSMaterialButtonRectangle btn_reserve;
